...
export default function Navbar() {
  ...
  return (
    <div className="w-full bg-transparent z-[1000] relative">
      <div 
        role="banner" 
        className="block fixed top-0 left-0 right-0 w-full h-[81px] bg-white dark:bg-gray-900 z-[1000] border-b border-[#e5e5e5] dark:border-gray-700"
      >
        <div className="container mx-auto h-full flex items-center justify-between px-10 max-w-[1200px]">
          ...
          <nav role="navigation" className="hidden md:flex items-center h-full gap-1">
            <Link 
              href="#About" 
              className="inline-block relative px-2.5 py-2.5 text-base text-black dark:text-white font-normal hover:opacity-70 transition-opacity"
            >
              About
            </Link>
            <Link 
            ...
            >
              <div className="flex items-center">
                <div className="text-base text-black dark:text-white font-normal mr-2 group-hover:opacity-70 transition-opacity">
                  Book a call
                </div>
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            >
              {isMobileMenuOpen ? (
                 <X className="w-6 h-6 text-[#333] dark:text-white" />
              ) : (
                 <Menu className="w-6 h-6 text-[#333] dark:text-white" />
              )}
            </div>
          </div>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-[81px] left-0 right-0 bg-white dark:bg-gray-900 border-b border-[#e5e5e5] dark:border-gray-700 px-10 py-5 flex flex-col gap-4 md:hidden shadow-lg animate-in slide-in-from-top-2">
            <Link 
              href="#About" 
              className="text-base text-black dark:text-white font-normal py-2 hover:opacity-70"
