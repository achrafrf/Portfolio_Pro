...
const HeroAnimation = () => {
  ...
  useGSAP(() => {
    ...
    // Animation dial les boxes (Panel Green)
  ...
  }, { scope: containerRef }); // Scope bach maykonoch machakil m3a selectors
    ...
    <main ref={containerRef}>
      ...
      <section className="hero-section">
        <div className="hero-container">
          <svg className="hero-bg-svg" viewBox="0 0 1200 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <radialGradient id="swirlGradient" cx="50%" cy="50%" r="80%">
                <stop offset="0%" stopColor="#0ae448" />
                <stop offset="60%" stopColor="#9d95ff" />
