...
export default function ProjectsSection() {
  ...
  return (
    <div id="projects" className="bg-background py-20 lg:py-24 text-foreground font-body overflow-hidden">
      <div className="container mx-auto px-5 lg:px-10 mb-12">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 lg:gap-0">
          <div className="max-w-2xl">
            ...
            <h2 className="text-[32px] md:text-[40px] lg:text-[48px] font-bold leading-[1.2] text-[#1a1a1a]">
              I bring results. <br />
          ...
          <a
            href="#"
            className="group relative inline-flex items-center justify-center overflow-hidden bg-black px-8 py-4 text-white min-w-[200px]"
          >
      ...
      <div className="container mx-auto px-5 lg:px-10 relative">
        <div className="overflow-hidden" ref={containerRef}>
          ...
          >
            {ASSETS.projects.map((project) => (
              ...
              >
                <div className="group block bg-white h-full relative">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h5 className="mb-3 text-xl font-bold text-[#1a1a1a]">
                      {project.title}
                    </h5>
                    
                    <a href={project.link} className="inline-flex items-center gap-2 text-base text-[#1a1a1a] group/link">
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
          ...
          <div className="flex gap-4 order-1 md:order-2">
            <button 
              onClick={prevSlide}
              className="group flex h-12 w-12 items-center justify-center border border-[#e5e5e5] hover:border-[#1a1a1a] bg-white transition-colors duration-300 hover:bg-[#1a1a1a]"
